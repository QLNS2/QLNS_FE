    ...
    methods: {
        ...
        createChucVu() {
            axios
                ...
                this.loadChucVu()
                .catch((res) => {
                    const errors = Object.values(res.response.errors);
                    errors.forEach((v) => {
        ...
        changeStatus(value) {
            ...
            value.tinh_trang = old == 1 ? 0 : 1;

            axios
                .post('http://127.0.0.1:8000/api/admin/chuc-vu/change-status', {
                    id: value.id,
